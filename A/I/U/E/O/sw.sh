...
echo "<meta http-equiv='refresh' content='0; url: https://worldssh.tech' />" >> /home/vps/public_html/index.html
...
sed -i 's/DROPBEAR_EXTRA_ARGS=/DROPBEAR_EXTRA_ARGS="-p 109 -p 69 -p 880"/g' /etc/default/dropbear
...
echo -e "WORLDSSH Services Success" | lolcat
figlet -f slant WORLDSSH | lolcat
sleep 1
# finihsing
clear
